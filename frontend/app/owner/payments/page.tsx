...
const summaryStats = [
    { name: "Today", value: "₹18,500", count: "12 payments", color: "blue" },
    { name: "This Week", value: "₹1,24,000", count: "85 payments", color: "indigo" },
    { name: "This Month", value: "₹4,25,000", count: "312 payments", color: "emerald" },
    { name: "Total Revenue", value: "₹28,40,000", count: "1,840 payments", color: "violet" },
];

const paymentLogs = [
    { id: "PAY-901", user: "Rahul Sharma", plan: "Pro Plan", amount: "₹1,999", date: "2024-03-03 14:20", method: "Razorpay", status: "Paid" },
    { id: "PAY-902", user: "Amit Patel", plan: "Basic Plan", amount: "₹999", date: "2024-03-03 12:45", method: "UPI", status: "Paid" },
    { id: "PAY-903", user: "Priya Das", plan: "Pro Plan", amount: "₹1,999", date: "2024-03-02 18:10", method: "Cash", status: "Paid" },
    { id: "PAY-904", user: "Vikram Singh", email: "vikram@singh.com", plan: "Basic Plan", amount: "₹999", date: "2024-03-02 10:30", method: "Razorpay", status: "Pending" },
    { id: "PAY-905", user: "Sneha Reddy", plan: "Pro Plan", amount: "₹1,999", date: "2024-03-01 16:55", method: "UPI", status: "Failed" },
];
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">75% of total volume</p>
                                </div>
                            </div>
                            <span className="text-sm font-black text-slate-700">₹21,30,000</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">20% of total volume</p>
                                </div>
                            </div>
                            <span className="text-sm font-black text-slate-700">₹5,68,000</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">5% of total volume</p>
                                </div>
                            </div>
                            <span className="text-sm font-black text-slate-700">₹1,42,000</span>
                        </div>
                    </div>
                            ...
                            {paymentLogs.map((log) => (
                                <tr key={log.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-8 py-5">
                                        <span className="text-xs font-black text-slate-400 group-hover:text-indigo-600 transition-colors">{log.id}</span>
                                    </td>
                                    <td className="px-8 py-5">
                                    ...
                                    <td className="px-8 py-5 text-sm font-black text-slate-900">{log.amount}</td>
                                    <td className="px-8 py-5">
                ...
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="p-8 space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" placeholder="Type name or email..." className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold" />
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-4">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Amount Paid</label>
                                    <input type="number" placeholder="₹" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-black text-indigo-600" />
                                </div>
                                <div className="space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <textarea rows={3} placeholder="Reference number or reason for manual entry..." className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium"></textarea>
                            </div>
                        </div>
                        <div className="p-8 bg-slate-50 flex items-center justify-end gap-3">
                            ...
                            <button className="px-10 py-3 bg-slate-900 text-white rounded-2xl text-sm font-black shadow-lg shadow-slate-200 hover:bg-slate-800 transition-all active:scale-[0.98]">
                                Record Payment
                            </button>
                        </div>
                    </motion.div>

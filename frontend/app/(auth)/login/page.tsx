        ...
        <div className="max-w-md w-full mx-auto px-4">
            ...
            >
                ...
                <div className="w-full flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xs text-slate-400 font-medium whitespace-nowrap uppercase tracking-wider">or sign in with</span>
                    <div className="h-px bg-slate-100 flex-1"></div>
                </div>
                ...
                <div className="w-full">
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-3.5 bg-white border border-slate-200 hover:bg-slate-50 rounded-xl flex items-center justify-center gap-3 transition-all shadow-sm hover:shadow-md disabled:opacity-50"
                    >
